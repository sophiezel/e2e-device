...
export function discoverHybridCases(domain: string): CaseEntry[] {
	return [
		// fast 模式：基础 hybrid 功能
		{
			...
			spec: `e2e-device/specs/${domain}.hybrid.lifecycle.spec.ts`,
		...
		},
		{
			...
			spec: `e2e-device/specs/${domain}.hybrid.navigation.spec.ts`,
		...
		// full 模式：进阶 hybrid 功能
		{
			...
			spec: `e2e-device/specs/${domain}.hybrid.bridge.spec.ts`,
		...
		},
		{
			...
			spec: `e2e-device/specs/${domain}.hybrid.error.spec.ts`,
		...
		},
		{
			...
			spec: `e2e-device/specs/${domain}.hybrid.performance.spec.ts`,
